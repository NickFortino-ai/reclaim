...
const resources: ResourceData[] = [
  ...
  // Testosterone
  {
    week: 1,
    category: 'drive',
    title: 'Dopamine Receptor Recovery: The First Step',
    source: 'Synapse, 2010',
    summary: 'Dopamine D2 receptors begin upregulating within days of removing supernormal stimuli. PET imaging studies show that receptor density starts recovering after just 2-4 weeks of abstinence, gradually restoring your ability to feel pleasure from everyday activities.',
    link: 'https://doi.org/10.1002/syn.20700',
  },
  {
    week: 1,
    category: 'drive',
    title: 'DeltaFosB: The Molecular Switch of Addiction',
    source: 'Nature Reviews Neuroscience, 2001 (Eric Nestler, Yale)',
    summary: 'DeltaFosB is a transcription factor that accumulates in the nucleus accumbens with repeated overconsumption of any highly rewarding stimulus. It physically rewires reward circuitry, making cravings automatic. The good news: it degrades over 6-8 weeks of abstinence, reversing the wiring.',
  },
  {
    week: 1,
    category: 'drive',
  ...
  },
  {
    week: 1,
    category: 'drive',
    title: 'Post-Orgasm Neurochemistry: The Prolactin Surge',
    source: 'Neuroscience & Biobehavioral Reviews, 2006',
    summary: 'After orgasm, prolactin surges while dopamine crashes, creating a refractory period of low motivation, fatigue, and reduced drive. With frequent pornography use, this cycle repeats multiple times daily, keeping you in a chronically depleted neurochemical state.',
  },
  ...
  // Testosterone
  {
    week: 2,
    category: 'drive',
    title: 'Dopamine D2 Receptor Downregulation',
    source: 'American Journal of Psychiatry, 2004',
    summary: 'Chronic overconsumption of high-dopamine stimuli causes D2 receptor downregulation — your brain literally removes dopamine receptors to protect itself from overstimulation. This is why everyday pleasures feel flat during active addiction. Receptor density recovers with sustained abstinence.',
  },
  {
    week: 2,
    category: 'drive',
  ...
  },
  {
    week: 2,
    category: 'drive',
    title: 'The Flatline Explained: Withdrawal Neurochemistry',
    source: 'Neuroscience & Biobehavioral Reviews, 2014',
    summary: 'The "flatline" — a period of low libido, motivation, and mood — occurs because your depleted dopamine system is recalibrating. With D2 receptors downregulated and dopamine production reduced, it takes weeks for your brain to restore normal signaling. This is a sign of healing, not damage.',
  },
  {
    week: 2,
    category: 'drive',
    title: 'Real Libido vs. Conditioned Arousal',
    source: 'Archives of Sexual Behavior, 2016',
    summary: 'Pornography conditions your arousal template to respond to pixels, novelty, and voyeurism rather than real-partner cues. True libido is a natural drive toward connection; conditioned arousal is a Pavlovian response to artificial stimuli. Recovery allows your brain to rediscover genuine desire.',
  },
  ...
  // Testosterone
  {
    week: 3,
    category: 'drive',
    title: 'Prefrontal Cortex Recovery and Impulse Control',
    source: 'JAMA Psychiatry, 2014 (Simone Kuhn, Max Planck Institute)',
    summary: 'Pornography use correlates with reduced gray matter in the prefrontal cortex — the brain region responsible for impulse control, planning, and decision-making. During recovery, this region rebuilds through neuroplasticity, restoring your ability to resist urges and make clear-headed choices.',
  },
  {
    week: 3,
    category: 'drive',
    title: 'Novelty-Seeking and the Escalation Trap',
    source: 'Archives of Sexual Behavior, 2016',
    summary: 'The brain releases more dopamine for novel stimuli than familiar ones. Internet pornography exploits this by offering infinite novelty, driving users to escalate to more extreme content. Understanding this mechanism — the Coolidge effect hijacked by technology — helps you recognize cravings as a neurological artifact, not genuine desire.',
  },
  {
    week: 3,
    category: 'drive',
    title: 'Why Motivation Returns During Recovery',
    source: 'Nature Reviews Neuroscience, 2011',
    summary: 'Dopamine is not just about pleasure — it is the neurotransmitter of motivation, drive, and wanting. When your dopamine system recalibrates during recovery, you regain the ability to feel motivated by real goals. The "superpowers" men report are simply your natural dopamine system coming back online.',
  },
  {
    week: 3,
    category: 'drive',
  ...
  // Testosterone
  {
    week: 4,
    category: 'drive',
    title: 'PIED Recovery: The Timeline',
    source: 'Behavioral Sciences, 2016',
    summary: 'Porn-Induced Erectile Dysfunction (PIED) results from conditioned arousal to screens rather than real partners. Clinical reports show that most men experience significant improvement in erectile function within 2-3 months of abstinence, with full recovery typically occurring by 5-6 months as the brain rewires to respond to real stimuli.',
  },
  {
    week: 4,
    category: 'drive',
    title: 'The Dopamine Recovery Timeline',
    source: 'Synapse, 2010',
    summary: 'Week 1-2: Withdrawal symptoms peak as dopamine levels drop. Week 3-4: D2 receptors begin upregulating, mood starts stabilizing. Month 2-3: Significant receptor recovery, natural pleasures feel rewarding again. Month 4-6: Near-complete dopamine system normalization. Your brain is on a predictable healing trajectory.',
  },
  {
    week: 4,
    category: 'drive',
  ...
  },
  {
    week: 4,
    category: 'drive',
    title: 'The Coolidge Effect and Supernormal Stimuli',
    source: 'Proceedings of the Royal Society B, 2007',
    summary: 'The Coolidge effect — renewed sexual interest upon encountering a novel partner — evolved for reproductive fitness. Internet pornography hijacks this by offering unlimited "novel partners," creating supernormal stimuli that no real experience can match. Understanding this removes shame and replaces it with neuroscience.',
  },
  ...
  { week: 5, category: 'drive', title: 'Sensitization vs. Habituation in Addiction', source: 'Neuroscience & Biobehavioral Reviews, 2016 (Terry Robinson, University of Michigan)', summary: 'Addiction involves two opposing processes: habituation (needing more to feel the same pleasure) and sensitization (cues triggering increasingly powerful cravings). This is why you can feel no pleasure from pornography yet still crave it intensely. Recovery reverses both processes.' },
  { week: 5, category: 'drive', title: 'The Power of Morning Sunlight', summary: 'Exposure to natural sunlight within 30 minutes of waking helps regulate circadian rhythm, which governs testosterone production. The testes have light-sensitive receptors that respond to UV exposure.' },
  { week: 5, category: 'drive', title: 'Pornography and Working Memory Impairment', source: 'Journal of Behavioral Addictions, 2015 (Laier & Brand, University of Duisburg-Essen)', summary: 'Pornography use was shown to impair working memory — the mental workspace you use for focus, problem-solving, and learning. During recovery, cognitive performance measurably improves as prefrontal resources are freed from craving-related processing.' },
  { week: 5, category: 'drive', title: 'Deep Breathing and Cortisol Reduction', summary: 'Box breathing (4-4-4-4) and diaphragmatic breathing activate the parasympathetic nervous system, reducing cortisol within minutes. Lower cortisol directly supports testosterone production.' },
  { week: 5, category: 'drive', title: 'Sexual Energy Transmutation: The Real Science', source: 'Frontiers in Psychology, 2019', summary: 'When sexual energy is not discharged through compulsive behavior, the underlying dopaminergic and noradrenergic arousal can be channeled into creative work, physical training, and goal pursuit. This is not mysticism — it is redirected neurochemical drive. Many high performers throughout history have described this phenomenon.' },
  ...
  { week: 6, category: 'drive', title: 'Reward Prediction Error and Dopamine', source: 'Neuron, 2016 (Wolfram Schultz, Cambridge)', summary: 'Dopamine neurons fire not for pleasure itself, but for the prediction of reward. Pornography trains your brain to predict massive dopamine spikes, making real-world rewards feel disappointing by comparison. As you recover, your prediction system recalibrates and normal experiences become rewarding again.' },
  { week: 6, category: 'drive', title: 'Sleep Architecture and Hormones', summary: 'Most testosterone is produced during REM sleep. Blue light from screens suppresses melatonin and disrupts sleep architecture. Eliminating screens 1 hour before bed optimizes hormonal production.' },
  { week: 6, category: 'drive', title: 'Oxytocin vs. Dopamine: Bonding vs. Craving', source: 'Psychoneuroendocrinology, 2012', summary: 'Dopamine drives craving and pursuit; oxytocin drives bonding and satisfaction. Pornography floods the dopamine system while starving the oxytocin system. Real human connection — touch, eye contact, conversation — activates oxytocin pathways, creating lasting fulfillment rather than fleeting highs.' },
  { week: 6, category: 'drive', title: 'Morning Erections as a Recovery Marker', source: 'Journal of Sexual Medicine, 2009', summary: 'The return of consistent morning erections is one of the most reliable indicators of neurological and vascular recovery. Nocturnal penile tumescence is driven by healthy dopamine and testosterone signaling during REM sleep. Many men in recovery report their return within 4-8 weeks as a clear sign of healing.' },
  { week: 6, category: 'drive', title: 'Overtraining and Testosterone Crash', summary: 'Excessive exercise without recovery suppresses testosterone and spikes cortisol. Rest days are not laziness — they are when your body builds muscle and optimizes hormones. Train hard, recover harder.' },
  ...
  { week: 7, category: 'drive', title: 'Neuroplasticity and Rewiring the Brain', source: 'Nature Reviews Neuroscience, 2009 (Michael Merzenich)', summary: 'Your brain physically reorganizes itself based on what you repeatedly do. Every day without pornography weakens the old neural pathways and strengthens new ones. Neuroplasticity works in both directions — the same mechanism that wired the addiction is now rewiring your recovery.' },
  { week: 7, category: 'drive', title: 'The Withdrawal Timeline: What to Expect', source: 'Journal of Behavioral Addictions, 2019', summary: 'Week 1-2: Irritability, insomnia, intense cravings. Week 3-4: The "flatline" — low mood, low libido, low energy. Week 5-7: Gradual lifting, moments of clarity and motivation returning. Week 8+: Stabilization, natural drive emerging. Knowing the timeline makes each phase manageable.' },
  { week: 7, category: 'drive', title: 'The Testosterone-Confidence Loop', summary: 'Testosterone increases confidence, and confident behavior increases testosterone. This positive feedback loop means that small wins during recovery compound into major changes in how you carry yourself.' },
  { week: 7, category: 'drive', title: 'Prolactin and the Post-Orgasm Hangover', source: 'Neuroscience & Biobehavioral Reviews, 2006', summary: 'Prolactin, released after orgasm, suppresses dopamine for hours to days. With frequent pornography use, chronically elevated prolactin creates persistent fatigue, brain fog, and low motivation. During recovery, prolactin levels normalize, restoring baseline energy and clarity.' },
  { week: 7, category: 'drive', title: 'Heavy Compound Lifts', summary: 'Squats, deadlifts, bench press, and overhead press recruit the most muscle fibers and produce the greatest acute testosterone response. 3-5 sets of 5-8 reps with heavy weight is optimal for hormonal response.' },
  ...
  { week: 8, category: 'drive', title: 'Two-Month Brain Recovery Checkpoint', source: 'JAMA Psychiatry, 2014', summary: 'At the two-month mark, PET and MRI studies show measurable recovery in both dopamine receptor density and prefrontal cortex gray matter. The brain changes that supported compulsive behavior are actively reversing. This is a critical milestone — your neurological foundation is substantially rebuilt.' },
  { week: 8, category: 'drive', title: 'Cue-Triggered Cravings and How They Fade', source: 'Psychopharmacology, 2016', summary: 'Cravings are triggered by environmental cues — specific times, locations, emotional states, or devices — that your brain has associated with pornography use. Through a process called extinction learning, these cue-craving links weaken with each exposure that does not result in the behavior. Over time, triggers lose their power.' },
  { week: 8, category: 'drive', title: 'Natural vs. Artificial Arousal Patterns', source: 'Behavioral Sciences, 2016', summary: 'Natural arousal follows a slow build tied to real-world cues — attraction, touch, emotional connection. Pornography-conditioned arousal is instant, visual, and disconnected from genuine desire. As you recover, you will notice arousal becoming slower but deeper, more connected to actual people and situations rather than screens.' },
  { week: 8, category: 'drive', title: 'The Two-Month Milestone', summary: 'At approximately 8 weeks of recovery, many men report a significant shift: energy stabilizes, motivation increases, and the "flatline" period typically ends. Your hormonal system is recalibrating.' },
  { week: 8, category: 'drive', title: 'Limiting Processed Foods', summary: 'Ultra-processed foods contain additives, seed oils, and preservatives that increase inflammation and disrupt endocrine function. Whole foods — meat, vegetables, fruits, nuts — are the foundation of hormonal health.' },
  ...
  { week: 9, category: 'drive', title: 'Dopamine Baseline vs. Spikes: Understanding Your Reward System', source: 'Trends in Cognitive Sciences, 2018 (Anna Lembke, Stanford)', summary: 'Your dopamine system has a baseline level (tonic dopamine) and spike capacity (phasic dopamine). Pornography creates massive spikes that crash your baseline below normal. Recovery raises your tonic dopamine back to healthy levels, meaning everyday life feels more rewarding and satisfying without artificial stimulation.' },
  { week: 9, category: 'drive', title: 'Meditation Lowers Cortisol', source: 'Health Psychology, 2014', summary: 'Regular meditation practice reduced cortisol by 23% in a meta-analysis of 45 studies. Since cortisol directly suppresses testosterone, meditation indirectly supports hormonal optimization.' },
  { week: 9, category: 'drive', title: 'Attention and Focus Improvements During Recovery', source: 'Journal of Behavioral Addictions, 2016', summary: 'Compulsive pornography use fragments attention and impairs sustained focus by depleting prefrontal resources. As you recover, executive function measurably improves — better concentration, clearer thinking, and enhanced ability to stay on task. Many men report this as one of the most noticeable benefits.' },
  { week: 9, category: 'drive', title: 'The Role of Endorphins in Natural Pleasure', source: 'Pharmacological Reviews, 2013', summary: 'Endorphins — your body\'s natural opioids — are released through exercise, social bonding, laughter, and accomplishment. Unlike the dopamine spike from pornography, endorphin-based pleasure is sustainable and non-depleting. Building a life rich in natural endorphin sources creates lasting well-being without the crash.' },
  { week: 9, category: 'drive', title: 'Nature Exposure and Stress Hormones', source: 'Frontiers in Psychology, 2019', summary: 'Spending just 20 minutes in nature reduced cortisol by 21%. Combining outdoor exercise with nature exposure creates a powerful hormonal optimization protocol.' },
  ...
  { week: 10, category: 'drive', title: 'Habit Loops: Cue, Routine, Reward', source: 'The Power of Habit, Charles Duhigg / MIT Neuroscience', summary: 'Every compulsive behavior follows a habit loop: a cue triggers a routine that delivers a reward. By identifying your specific cues (boredom, stress, being alone at night) you can consciously insert new routines (exercise, cold shower, calling a friend) that satisfy the underlying need without the destructive behavior.' },
  { week: 10, category: 'drive', title: 'Progressive Overload Principle', summary: 'Gradually increasing weight, reps, or volume in strength training continually challenges the body to produce more testosterone. Stagnant workouts produce stagnant hormonal responses.' },
  { week: 10, category: 'drive', title: 'BDNF and Brain Recovery', source: 'Nature Medicine, 2011', summary: 'Brain-Derived Neurotrophic Factor (BDNF) is a protein that promotes neuronal growth and repair. Exercise, sleep, and abstinence from addictive behaviors all increase BDNF production. Higher BDNF levels accelerate the brain rewiring process, helping you build new neural pathways faster during recovery.' },
  { week: 10, category: 'drive', title: 'Libido vs. Compulsion: Knowing the Difference', source: 'Archives of Sexual Behavior, 2019', summary: 'Healthy libido is a warm, embodied desire for connection that feels expansive and good. Compulsion is an anxious, urgent need to use pornography that feels contracting and desperate. Learning to distinguish between the two is a key skill in recovery — true libido grows stronger as compulsion fades.' },
  { week: 10, category: 'drive', title: 'Cold Water Immersion', summary: 'Cold water immersion at 14°C for 10-15 minutes post-workout reduces inflammation, speeds recovery, and stimulates brown fat activation. The acute stress response may support testosterone production.' },
  ...
  { week: 11, category: 'drive', title: 'Gray Matter Recovery in the Prefrontal Cortex', source: 'JAMA Psychiatry, 2014 (Simone Kuhn, Max Planck Institute)', summary: 'Brain imaging studies show that pornography use correlates with reduced gray matter in the right caudate and prefrontal cortex. The encouraging finding: gray matter volume recovers during sustained abstinence. At 11 weeks, your prefrontal cortex is measurably rebuilding, strengthening your willpower, decision-making, and emotional regulation.' },
  { week: 11, category: 'drive', title: 'The Circadian Testosterone Cycle', summary: 'Testosterone peaks between 6-8 AM and drops to its lowest around midnight. Aligning your schedule with this rhythm — intense activity in the morning, rest at night — optimizes your hormonal environment.' },
  { week: 11, category: 'drive', title: 'Emotional Regulation and Recovery', source: 'Cognition & Emotion, 2018', summary: 'Pornography often serves as an emotion regulation tool — numbing stress, anxiety, or loneliness. As the brain heals, you develop healthier emotional regulation capacity. The prefrontal cortex recovery at this stage means you can sit with difficult emotions without needing to escape into compulsive behavior.' },
  { week: 11, category: 'drive', title: 'Anti-Inflammatory Diet', summary: 'Chronic inflammation suppresses testosterone. An anti-inflammatory diet rich in turmeric, ginger, berries, leafy greens, and fatty fish reduces systemic inflammation and supports hormonal health.' },
  { week: 11, category: 'drive', title: 'The Science of Willpower Depletion and Renewal', source: 'Annual Review of Psychology, 2017 (Roy Baumeister)', summary: 'Willpower operates like a muscle — it fatigues with use but strengthens with training. Each time you resist an urge, you temporarily deplete willpower but build long-term self-control capacity. At 11 weeks, your willpower muscle is significantly stronger than when you started, making resistance progressively easier.' },
  ...
  { week: 12, category: 'drive', title: 'Three-Month Dopamine System Checkpoint', source: 'Journal of Behavioral Addictions, 2019', summary: 'At 90 days, research shows dopamine receptor density approaches baseline levels, cravings significantly decrease, and executive function shows marked improvement. Your reward system has substantially recalibrated — everyday activities feel more pleasurable, motivation is more consistent, and the compulsive pull has weakened dramatically.' },
  { week: 12, category: 'drive', title: 'The Three-Month Hormonal Checkpoint', summary: 'At 12 weeks of recovery, testosterone levels have typically stabilized significantly. Many men report clearer skin, improved body composition, deeper voice, and increased facial hair growth around this milestone.' },
  { week: 12, category: 'drive', title: 'Porn-Induced Sexual Dysfunction Research', source: 'Behavioral Sciences, 2016 (Gary Wilson / Prause et al.)', summary: 'A growing body of clinical research documents that internet pornography is a significant factor in rising rates of erectile dysfunction, delayed ejaculation, and anorgasmia in young men. These conditions, once rare in men under 40, resolve in the majority of cases after 2-6 months of sustained abstinence from pornography.' },
  { week: 12, category: 'drive', title: 'Stress Response System Recalibration', source: 'Psychoneuroendocrinology, 2016', summary: 'Chronic pornography use dysregulates the HPA axis (hypothalamic-pituitary-adrenal), keeping you in a state of elevated stress hormones. After three months of recovery, cortisol patterns normalize, stress resilience improves, and your body shifts from a chronic stress state to a recovery-oriented state. You handle pressure better and recover from setbacks faster.' },
  { week: 12, category: 'drive', title: 'Socializing and Testosterone', summary: 'Positive social interactions — laughing with friends, engaging in group activities, team sports — naturally increase testosterone. Isolation, by contrast, lowers it. Community is hormonal medicine.' },
  ...
  { week: 13, category: 'drive', title: 'The Default Mode Network and Recovery', source: 'NeuroImage, 2019', summary: 'The default mode network (DMN) is active during mind-wandering and is often hijacked by addiction-related rumination and craving. After 13 weeks of recovery, DMN activity normalizes — your autopilot thoughts shift from craving and fantasy to constructive self-reflection and future planning. Your resting brain becomes your ally again.' },
  { week: 13, category: 'drive', title: 'Grip Strength as Testosterone Marker', source: 'Journal of Strength and Conditioning Research, 2011', summary: 'Grip strength is positively correlated with testosterone levels and is a reliable marker of overall health. Training grip through dead hangs, farmer walks, and thick-bar training supports hormonal health.' },
  { week: 13, category: 'drive', title: 'Arousal Template Rewiring Progress', source: 'Archives of Sexual Behavior, 2016', summary: 'By week 13, your arousal template has undergone significant rewiring. The conditioned response to screens and artificial novelty is weakening while natural arousal pathways are strengthening. Many men report that attraction to real people feels more vivid and embodied than before — a sign that your brain is reconnecting desire with genuine human connection.' },
  { week: 13, category: 'drive', title: 'The Recovery Day Protocol', summary: 'Active recovery — light walking, stretching, foam rolling, cold exposure — on rest days supports muscle repair and hormonal recovery better than complete inactivity. Movement aids recovery.' },
  { week: 13, category: 'drive', title: 'Quarter-Year Drive Assessment', summary: 'At 13 weeks, take stock of how your drive and energy have transformed. Compare your current motivation, focus, confidence, and natural vitality to where you started. The consistent energy, clear thinking, authentic desire, and emotional stability you feel now are the result of a brain that has substantially healed. This is your new baseline — and it keeps improving.' },
  ...
  { week: 14, category: 'drive', title: 'Tolerance and Sensitization in Addiction', source: 'Neuroscience & Biobehavioral Reviews, 2011', summary: 'Addiction involves two paradoxical brain processes: tolerance (needing more stimulation for the same dopamine response) and sensitization (heightened craving triggered by associated cues). Understanding these dual mechanisms explains why porn use escalates and why complete abstinence — not moderation — is required to reset both systems.' },
  { week: 14, category: 'drive', title: 'Eccentric Training for Hormonal Response', summary: 'Emphasizing the lowering (eccentric) phase of lifts creates more muscle damage and a stronger hormonal response. Slow, controlled negatives (3-4 seconds) maximize testosterone and growth hormone release.' },
  { week: 14, category: 'drive', title: 'The Amygdala Hijack and Porn Cues', source: 'Biological Psychiatry, 2014', summary: 'The amygdala — your brain\'s threat and salience detector — becomes hypersensitive to porn-related cues after chronic use. Seeing a triggering image activates a fight-or-flight-like response that bypasses rational thought. Over months of abstinence, this hair-trigger reactivity gradually calms as the amygdala recalibrates to normal stimuli.' },
  { week: 14, category: 'drive', title: 'Delayed Ejaculation Recovery Science', source: 'Journal of Sexual Medicine, 2016', summary: 'Porn-induced delayed ejaculation occurs when the brain becomes conditioned to respond only to the specific visual and auditory stimulation of pornography. Recovery involves retraining arousal pathways through abstinence from porn and gradual re-sensitization to real physical touch — a process that typically takes 2-6 months.' },
  { week: 14, category: 'drive', title: 'Laughter and Hormones', source: 'Alternative Therapies in Health and Medicine, 2003', summary: 'Genuine laughter decreased cortisol by 39% and increased endorphins significantly. A good sense of humor is not just social — it is hormonal medicine.' },
  ...
  { week: 15, category: 'drive', title: 'Ventral Striatum and Reward Processing', source: 'Neuropsychopharmacology, 2014', summary: 'The ventral striatum is the brain\'s core reward-processing center. Chronic porn use reduces its activation in response to normal rewards while increasing reactivity to porn cues. Recovery allows the ventral striatum to recalibrate, restoring your ability to feel motivated and rewarded by everyday achievements and real human connection.' },
  { week: 15, category: 'drive', title: 'The Benefits of Morning Training', summary: 'Training in the morning capitalizes on naturally elevated testosterone and cortisol levels. Morning exercise also sets a positive hormonal cascade that benefits the entire day.' },
  { week: 15, category: 'drive', title: 'Real Arousal vs. Compulsive Seeking', source: 'Frontiers in Human Neuroscience, 2016', summary: 'There is a critical difference between genuine sexual arousal (a healthy response to attraction and connection) and compulsive seeking (the dopamine-driven urge to search for novel stimuli). Learning to distinguish between the two is a key milestone in recovery — real arousal feels calm and present, while compulsive seeking feels urgent and anxious.' },
  { week: 15, category: 'drive', title: 'Porn-Induced Brain Fog: The Science', source: 'Psychiatry Research: Neuroimaging, 2015', summary: 'The "brain fog" reported by heavy porn users has a neurological basis: chronic overstimulation impairs prefrontal cortex function, reducing working memory, concentration, and mental clarity. As dopamine receptors recover and prefrontal connectivity strengthens during abstinence, cognitive sharpness returns — often described as "the fog lifting."' },
  { week: 15, category: 'drive', title: 'Mind-Muscle Connection', summary: 'Mentally focusing on the muscle being trained increases muscle activation by up to 22%. This enhanced activation creates a stronger growth stimulus and potentially greater hormonal response per exercise.' },
  ...
  { week: 16, category: 'drive', title: 'Dopamine Receptor Density Recovery at Four Months', source: 'Synapse, 2010', summary: 'PET imaging studies of addiction recovery show that dopamine D2 receptor density continues to increase through the fourth month of abstinence. At this stage, your brain\'s reward system is substantially more sensitive to natural pleasures than it was at the start. Everyday experiences — a good meal, a sunset, a conversation — now register as genuinely rewarding again.' },
  { week: 16, category: 'drive', title: 'The Anterior Cingulate Cortex and Self-Control', source: 'NeuroImage, 2011', summary: 'The anterior cingulate cortex (ACC) monitors conflict between impulses and goals, playing a crucial role in self-control. Chronic porn use thins the ACC, weakening willpower. Research shows that sustained abstinence, mindfulness practice, and regular exercise promote ACC thickening and improved impulse regulation.' },
  { week: 16, category: 'drive', title: 'Sleep Apnea and Testosterone', source: 'Journal of Clinical Endocrinology & Metabolism, 2002', summary: 'Untreated sleep apnea can reduce testosterone by 50%. If you snore heavily, wake tired, or experience daytime sleepiness despite adequate sleep hours, get evaluated for sleep apnea.' },
  { week: 16, category: 'drive', title: 'The Farmer Walk Effect', summary: 'Carrying heavy weights while walking (farmer walks) creates a unique full-body stimulus that elevates testosterone, builds grip strength, and develops functional core stability simultaneously.' },
  { week: 16, category: 'drive', title: 'Sexual Confidence vs. Performance Anxiety', source: 'Journal of Sexual Medicine, 2015', summary: 'Performance anxiety during sex is strongly linked to porn-conditioned expectations. The brain compares real experiences to an unrealistic standard, triggering a stress response that inhibits arousal. As porn\'s influence fades during recovery, sexual confidence builds naturally because arousal becomes rooted in presence and connection rather than performance.' },
  ...
  { week: 17, category: 'drive', title: 'The Benefits of Walking', summary: 'A daily 30-minute walk reduces cortisol, improves insulin sensitivity, and supports testosterone production without the stress of intense exercise. Walking is the most underrated hormonal optimization tool.' },
  { week: 17, category: 'drive', title: 'Hedonic vs. Eudaimonic Pleasure', source: 'Proceedings of the National Academy of Sciences, 2013', summary: 'Hedonic pleasure (sensory gratification) and eudaimonic pleasure (meaning-derived fulfillment) activate different gene expression profiles. Hedonic-dominant lifestyles increase inflammatory gene expression, while eudaimonic engagement reduces it. Recovery shifts your pleasure balance from hedonic consumption toward eudaimonic fulfillment — and your biology rewards the shift.' },
  { week: 17, category: 'drive', title: 'The Impact of Artificial Light', summary: 'Artificial blue light after sunset suppresses melatonin by 50-90%, disrupting sleep architecture and consequently testosterone production. Use blue-light blocking glasses or night mode after dark.' },
  { week: 17, category: 'drive', title: 'Natural Libido Cycles and What\'s Normal', source: 'Hormones and Behavior, 2005', summary: 'Healthy male libido naturally fluctuates based on stress, sleep, season, and relationship dynamics. Porn creates an artificial constant that masks these normal cycles. During recovery, learning to recognize and accept natural fluctuations — without interpreting low periods as problems — is an important part of developing a healthy relationship with your sexuality.' },
  { week: 17, category: 'drive', title: 'The Role of Serotonin in Recovery', source: 'Biological Psychiatry, 2008', summary: 'Serotonin regulates mood, impulse control, and sexual function. Chronic porn use disrupts serotonin signaling, contributing to irritability, compulsivity, and emotional flatness. During recovery, serotonin function normalizes — improving mood stability, patience, and emotional resilience. Exercise, sunlight exposure, and social connection all support healthy serotonin production.' },
  ...
  { week: 18, category: 'drive', title: 'Four-Month Neuroplasticity Checkpoint', source: 'Cerebral Cortex, 2015', summary: 'At four months of sustained behavioral change, neuroimaging studies show measurable increases in prefrontal gray matter volume and white matter integrity. Your brain is physically restructuring itself — strengthening the circuits responsible for decision-making, impulse control, and emotional regulation while weakening the porn-conditioned pathways.' },
  { week: 18, category: 'drive', title: 'Porn and Attachment Style Disruption', source: 'Journal of Sex & Marital Therapy, 2017', summary: 'Regular porn use can shift attachment styles toward insecure patterns — increasing avoidance of real intimacy and anxiety about relationships. The brain learns to associate sexual reward with isolation rather than connection. Recovery gradually restores secure attachment tendencies as oxytocin and vasopressin systems normalize through real human bonding.' },
  { week: 18, category: 'drive', title: 'Energy Metabolism and Recovery', source: 'Neuroscience & Biobehavioral Reviews, 2016', summary: 'Chronic addiction dysregulates cellular energy metabolism in the brain, reducing mitochondrial efficiency and contributing to fatigue and low motivation. As the brain recovers from overstimulation, mitochondrial function improves, restoring the natural energy and vitality that many men describe as one of the most noticeable benefits of sustained abstinence.' },
  { week: 18, category: 'drive', title: 'Emotional Eating and Hormones', summary: 'Stress-induced eating of high-sugar, high-fat foods spikes insulin and cortisol while suppressing testosterone. Breaking the emotional eating pattern is a key part of hormonal optimization.' },
  { week: 18, category: 'drive', title: 'Four-Month Recovery Assessment', summary: 'At 18 weeks, you are beyond most testosterone recovery timelines. Your baseline hormonal state is now significantly improved. The benefits compound from here — the best is still ahead.' },
  ...
  { week: 19, category: 'drive', title: 'Norepinephrine and Alertness During Recovery', source: 'Neuropsychopharmacology, 2015', summary: 'Norepinephrine — the brain\'s alertness and focus neurotransmitter — is dysregulated during addiction, contributing to brain fog and poor concentration. As recovery progresses, norepinephrine signaling normalizes, sharpening attention, increasing mental clarity, and restoring the focused alertness that drives productivity and engagement with life.' },
  { week: 19, category: 'drive', title: 'The Wim Hof Method', summary: 'Cold exposure combined with specific breathing techniques (Wim Hof Method) has been shown to improve hormonal balance, reduce inflammation, and strengthen the immune system in clinical studies.' },
  { week: 19, category: 'drive', title: 'Erectile Quality as Neurological Health Marker', source: 'Journal of Sexual Medicine, 2015', summary: 'Erectile quality is a direct indicator of neurological and vascular health. Porn-induced erectile dysfunction results from desensitized dopamine signaling rather than physical damage. As the reward system recovers, erectile response to real stimulation strengthens — making morning erections and spontaneous arousal reliable markers of brain recovery progress.' },
  { week: 19, category: 'drive', title: 'Loaded Carries for Full-Body Hormonal Response', summary: 'Walking with heavy weights (suitcase carry, overhead carry, yoke walk) engages the entire kinetic chain and produces a strong hormonal response similar to squats and deadlifts.' },
  { week: 19, category: 'drive', title: 'The Mesolimbic Pathway Explained', source: 'Nature Reviews Neuroscience, 2004', summary: 'The mesolimbic dopamine pathway — running from the ventral tegmental area to the nucleus accumbens — is the brain\'s core motivation circuit. Porn hijacks this pathway through supernormal stimulation, reducing its responsiveness to normal rewards. Recovery restores healthy mesolimbic function, reigniting natural motivation, curiosity, and drive toward real-world goals.' },
  ...
  { week: 20, category: 'drive', title: 'Androgen Receptor Upregulation During Recovery', source: 'Urology, 2004', summary: 'The "superpowers" many men report during recovery may be partly explained by androgen receptor upregulation. When dopamine signaling normalizes, androgen receptor density and sensitivity can increase — making your existing testosterone more effective without actual hormonal changes. Your body becomes better at using what it already produces.' },
  { week: 20, category: 'drive', title: 'The Cold Thermogenesis Protocol', summary: 'Graduated cold exposure: Week 1 — cold finishes to showers. Week 2 — full cold showers. Week 3 — cold water face dunks. Week 4 — cold baths. This progressive approach builds cold tolerance and hormonal resilience.' },
  { week: 20, category: 'drive', title: 'Cortical Thickness and Self-Regulation', source: 'Cerebral Cortex, 2013', summary: 'Neuroimaging research reveals that cortical thickness in the prefrontal and insular regions predicts self-regulation capacity. Chronic porn use is associated with thinner cortex in these areas. The encouraging finding: sustained behavioral change, meditation, and exercise promote cortical thickening — physically building the brain structures responsible for willpower and emotional control.' },
  { week: 20, category: 'drive', title: 'The Deadlift: King of Testosterone Exercises', summary: 'The conventional deadlift engages more muscle mass than any other single exercise, producing the largest systemic hormonal response. Proper form is essential — never sacrifice technique for weight.' },
  { week: 20, category: 'drive', title: 'Sexual Response Cycle Normalization', source: 'Archives of Sexual Behavior, 2016', summary: 'The human sexual response cycle — desire, arousal, plateau, orgasm, resolution — becomes distorted by porn use, often compressing or eliminating key phases. Five months into recovery, this cycle normalizes: desire becomes more spontaneous, arousal builds more naturally, and orgasm becomes more satisfying because the full neurochemical cascade is restored.' },
  ...
  { week: 21, category: 'drive', title: 'Five-Month Reward System Assessment', source: 'Biological Psychiatry, 2017', summary: 'At five months, your reward system has undergone significant recalibration. Assess the changes: Do everyday activities feel more enjoyable? Is your motivation more stable? Are you pursuing goals with sustained energy rather than short bursts? These are signs that your dopamine baseline has risen and your reward sensitivity has normalized.' },
  { week: 21, category: 'drive', title: 'Sprint Interval Training Protocol', summary: 'The research-backed protocol: 6-8 all-out sprints of 30 seconds with 90-second rest periods, 2-3 times per week. This produces a superior testosterone and growth hormone response compared to steady-state cardio.' },
  { week: 21, category: 'drive', title: 'The Gut-Brain Axis and Mood Recovery', source: 'Frontiers in Psychiatry, 2019', summary: 'The gut-brain axis — a bidirectional communication system between your intestinal microbiome and your brain — profoundly influences mood, motivation, and cravings. Chronic stress from addiction disrupts gut bacteria, reducing serotonin and dopamine precursor production. Recovery, combined with a whole-food diet, restores gut health and the neurochemical support your brain needs.' },
  { week: 21, category: 'drive', title: 'Phantom Arousal and How It Fades', source: 'Behavioural Brain Research, 2016', summary: 'Early in recovery, many men experience phantom arousal — spontaneous, contextless sexual urges not triggered by any real stimulus. This is the sensitized brain firing along porn-conditioned pathways. Over time, these phantom signals diminish as neural pruning weakens unused pathways. By five months, most men report that arousal becomes more situationally appropriate and connected to real attraction.' },
  { week: 21, category: 'drive', title: 'The Five-Month Hormonal Assessment', summary: 'At 21 weeks, assess your progress: Energy levels? Morning drive? Workout performance? Confidence? Body composition? Compare honestly to your baseline. The changes are real and measurable.' },
  ...
  { week: 22, category: 'drive', title: 'Stimulus Generalization and Narrowing', source: 'Learning & Behavior, 2015', summary: 'Porn use causes stimulus generalization (arousal to increasingly varied content) while simultaneously narrowing real-world arousal (less responsiveness to actual partners). During recovery, this reverses: your arousal template narrows away from artificial stimuli and broadens toward real-world connection, touch, and emotional intimacy — a healthier and more satisfying pattern.' },
  { week: 22, category: 'drive', title: 'Testosterone and Dopamine: Separate but Connected Systems', source: 'Hormones and Behavior, 2009', summary: 'While testosterone and dopamine are distinct neurochemical systems, they interact powerfully. Dopamine facilitates testosterone\'s effects on motivation and drive, while testosterone modulates dopamine receptor sensitivity. Recovering one system supports the other — which is why dopamine recovery from porn abstinence amplifies the motivational effects of healthy testosterone levels.' },
  { week: 22, category: 'drive', title: 'Sleep Temperature Optimization', summary: 'Testicular testosterone production is optimized at slightly below body temperature. Sleeping in a cool room (65-68°F) and wearing loose-fitting sleepwear supports overnight hormonal production.' },
  { week: 22, category: 'drive', title: 'Testosterone and Cardiovascular Health', source: 'Journal of the American Heart Association, 2016', summary: 'Healthy testosterone levels are associated with better cardiovascular health, improved lipid profiles, and reduced risk of metabolic syndrome. Hormonal optimization is cardiovascular protection.' },
  { week: 22, category: 'drive', title: 'Breaking Through the Brain Recovery Plateau', source: 'Neuroscience & Biobehavioral Reviews, 2018', summary: 'Around months 4-6, many men hit a recovery plateau where progress feels stalled. This is actually a phase of consolidation — your brain is stabilizing new neural patterns. To accelerate through it, introduce novel challenges: learn a new skill, increase social engagement, try a new form of exercise, or start a creative project. Novelty stimulates neuroplasticity without the damage of artificial stimulation.' },
  ...
  { week: 23, category: 'drive', title: 'Prefrontal Cortex Maturation at Six Months', source: 'NeuroImage, 2015', summary: 'The prefrontal cortex — responsible for planning, judgment, and impulse control — continues strengthening throughout recovery. At six months, neuroimaging shows significant restoration of prefrontal gray matter and connectivity. This translates to better decision-making, stronger willpower, and reduced susceptibility to impulsive behavior across all areas of life.' },
  { week: 23, category: 'drive', title: 'Compulsivity vs. Impulsivity in Addiction', source: 'Neuropsychopharmacology, 2010', summary: 'Addiction involves both impulsivity (acting without thinking) and compulsivity (continuing despite negative consequences). Early porn use is driven by impulsivity; chronic use becomes compulsive. Recovery addresses both: impulsivity decreases as prefrontal function recovers, while compulsivity fades as the habit loops weaken through disuse and new behavioral patterns take hold.' },
  { week: 23, category: 'drive', title: 'Morning Vitality as Recovery Metric', summary: 'How you feel in the first 30 minutes after waking is one of the most reliable indicators of neurochemical health. Consistent morning energy, mental clarity, and positive anticipation for the day reflect normalized dopamine, cortisol, and serotonin function. Track your morning vitality on a 1-10 scale — rising scores confirm your brain\'s ongoing recovery.' },
  { week: 23, category: 'drive', title: 'The Parasympathetic State', summary: 'Chronic sympathetic (fight-or-flight) activation suppresses testosterone. Practices that activate the parasympathetic system — deep breathing, yoga, meditation, massage — shift the hormonal environment in your favor.' },
  { week: 23, category: 'drive', title: 'Tracking Your Progress', summary: 'Consider tracking objective markers: morning energy (1-10), workout performance, libido, sleep quality. This data helps identify what\'s working and provides motivation through visible trends.' },
  ...
  { week: 24, category: 'drive', title: 'The Six-Month Hormonal Milestone', summary: 'At 6 months, your endocrine system has fully recalibrated from the effects of chronic pornography use. Testosterone, cortisol, and dopamine systems are operating at optimized baseline levels.' },
  { week: 24, category: 'drive', title: 'Six-Month Dopamine System Milestone', source: 'Neuroscience & Biobehavioral Reviews, 2020', summary: 'At six months, your dopamine system has reached a critical milestone. D2 receptor density has substantially recovered, baseline dopamine levels have normalized, and the sensitized pathways to porn cues have significantly weakened. You are now operating with a reward system that can find genuine satisfaction in real accomplishments, relationships, and experiences.' },
  { week: 24, category: 'drive', title: 'Sexual Satisfaction Without Porn', source: 'Archives of Sexual Behavior, 2017', summary: 'Research consistently shows that men who abstain from pornography report higher sexual satisfaction with real partners. At six months, your brain has substantially rewired to find real intimacy more arousing than pixels on a screen. This is not willpower — it is neuroplasticity. Your arousal template has genuinely shifted toward authentic human connection.' },
  { week: 24, category: 'drive', title: 'Intrinsic Motivation and Dopamine Recovery', source: 'Psychological Bulletin, 2017', summary: 'Intrinsic motivation — doing things because they are inherently rewarding — depends on healthy dopamine signaling. Porn depletes this system, making everything feel effortful and unrewarding. At six months of recovery, intrinsic motivation returns powerfully. Projects, hobbies, relationships, and career goals feel naturally engaging because your brain can once again generate reward from meaningful effort.' },
  { week: 24, category: 'drive', title: 'Building Sustainable Habits', summary: 'The supplements and protocols that work for you are only valuable if sustainable. Focus on a core set of practices you can maintain for life rather than an unsustainable all-in approach.' },
  ...
  { week: 25, category: 'drive', title: 'Stress Resilience and HPA Axis Recovery', source: 'Psychoneuroendocrinology, 2018', summary: 'The HPA axis (hypothalamic-pituitary-adrenal) — your body\'s central stress response system — becomes dysregulated during chronic addiction, producing excessive cortisol and heightened anxiety. By six months of recovery, HPA axis function normalizes: cortisol patterns become healthier, stress resilience increases, and the constant low-grade anxiety that accompanied active addiction substantially resolves.' },
  { week: 25, category: 'drive', title: 'The Benefits of Play', summary: 'Recreational play — team sports, martial arts, hiking, climbing — stimulates testosterone through a combination of physical exertion, competition, and social bonding. Training doesn\'t have to feel like training.' },
  { week: 25, category: 'drive', title: 'Decision-Making Quality Improvements', source: 'Cognitive, Affective, & Behavioral Neuroscience, 2016', summary: 'Recovered prefrontal cortex function translates directly to better decision-making. Research shows that at 6+ months of behavioral addiction recovery, performance on decision-making tasks improves significantly — including better risk assessment, reduced impulsivity, and improved ability to delay gratification. These improvements extend to career, financial, and relationship decisions.' },
  { week: 25, category: 'drive', title: 'The Science of "Superpowers" Explained', source: 'Frontiers in Psychology, 2016', summary: 'The "superpowers" reported during recovery — increased confidence, social magnetism, energy, and mental clarity — are not placebo. They result from measurable neurobiological changes: normalized dopamine sensitivity amplifies motivation, recovered prefrontal function improves social cognition, reduced anxiety increases social confidence, and restored neurochemical balance produces genuine vitality.' },
  { week: 25, category: 'drive', title: 'Recovery Beyond Testosterone', summary: 'Remember: testosterone is a marker, not the goal. The real benefits of recovery are clarity, connection, integrity, and freedom. Hormonal optimization is a side effect of living well.' },
  ...
  { week: 26, category: 'drive', title: 'The Half-Year Hormonal Assessment', summary: 'At 26 weeks, take comprehensive stock: How does your energy, drive, body composition, and confidence compare to 6 months ago? Document these changes — they are evidence of your transformation.' },
  { week: 26, category: 'drive', title: 'Half-Year Brain Remodeling Assessment', source: 'NeuroImage Clinical, 2019', summary: 'At 26 weeks, your brain has undergone substantial structural remodeling. Increased prefrontal gray matter, strengthened white matter connectivity, normalized reward circuit sensitivity, and recovered executive function are all documented at this stage. This is not abstract — these changes manifest as the improved clarity, motivation, emotional stability, and confidence you experience daily.' },
  { week: 26, category: 'drive', title: 'Creativity and Divergent Thinking in Recovery', source: 'Neuropsychologia, 2019', summary: 'Many men in long-term recovery report a creative renaissance — and neuroscience explains why. Recovered dopamine function enhances divergent thinking (the ability to generate novel ideas), while restored prefrontal connectivity improves the capacity to develop and execute creative projects. The energy once consumed by compulsive behavior is now available for art, writing, music, and innovation.' },
  { week: 26, category: 'drive', title: 'Porn-Free Sexual Health at Six Months', source: 'Journal of Sexual Medicine, 2018', summary: 'At six months without porn, sexual health markers show significant improvement: stronger and more reliable erections, increased sensitivity to physical touch, more satisfying orgasms, and arousal that is triggered by real attraction rather than conditioned cues. These changes reflect genuine neurological healing — your sexual response system is operating as nature intended.' },
  { week: 26, category: 'drive', title: 'Sustainability Over Optimization', summary: 'The best testosterone protocol is the one you actually do consistently. A simple routine maintained for years beats an elaborate protocol abandoned after weeks. Consistency trumps complexity.' },
  ...
  { week: 27, category: 'drive', title: 'Myelin Repair and White Matter Recovery', source: 'Frontiers in Neuroanatomy, 2018', summary: 'Myelin, the fatty sheath insulating nerve fibers, is damaged by chronic overstimulation. Research shows white matter integrity begins measurably improving after 6+ months of recovery, restoring faster neural communication and cognitive sharpness.' },
  { week: 27, category: 'drive', title: 'The Benefits of Hiking', summary: 'Hiking combines multiple testosterone-boosting factors: nature exposure (reduces cortisol), physical exertion (stimulates testosterone), sunlight (vitamin D), and social bonding when done with others.' },
  { week: 27, category: 'drive', title: 'Emotional Numbness Reversal During Recovery', source: 'Neuroscience & Biobehavioral Reviews, 2019', summary: 'Chronic supranormal dopamine stimulation downregulates emotional processing circuits. As receptor density normalizes around month 7, many people experience a profound return of emotional depth -- both positive and negative feelings become richer and more textured.' },
  { week: 27, category: 'drive', title: 'The Importance of Warm-Up', summary: 'A proper warm-up primes the nervous system and endocrine system for maximum performance. 10 minutes of progressive warm-up before heavy training optimizes both safety and hormonal response.' },
  { week: 27, category: 'drive', title: 'The Neuroscience of Boredom Tolerance', source: 'Perspectives on Psychological Science, 2012', summary: 'Boredom signals a gap between desired and actual stimulation. Recovery rebuilds tolerance for low-stimulation states by restoring baseline dopamine. Learning to sit with boredom without seeking instant relief is one of the most powerful neuroplastic changes you can make.' },
  ...
  { week: 28, category: 'drive', title: 'Dopamine Fasting: Evidence and Myths', source: 'International Journal of Environmental Research and Public Health, 2020', summary: 'The viral concept of "dopamine fasting" is a misnomer -- you cannot deplete dopamine by avoiding stimulation. However, temporarily reducing high-stimulation activities does allow receptor sensitivity to upregulate, which is exactly what sustained recovery achieves.' },
  { week: 28, category: 'drive', title: 'Martial Arts and Hormonal Benefits', summary: 'Martial arts training combines competitive drive, intense physical exertion, mental discipline, and social hierarchy — all of which stimulate testosterone production through complementary pathways.' },
  { week: 28, category: 'drive', title: 'Memory Consolidation Improvements in Recovery', source: 'Hippocampus, 2016', summary: 'The hippocampus, critical for converting short-term memories into long-term ones, is highly sensitive to dopamine dysregulation. As dopamine signaling normalizes, many people notice sharper recall, better learning retention, and improved ability to remember names, facts, and conversations.' },
  { week: 28, category: 'drive', title: 'Sexual Arousal Concordance: Mind-Body Alignment', source: 'Archives of Sexual Behavior, 2010', summary: 'Arousal concordance refers to how well your subjective sense of arousal matches your physical response. Pornography disrupts this alignment by training arousal to visual cues disconnected from bodily experience. Recovery restores concordance, meaning your mind and body begin responding together again.' },
  { week: 28, category: 'drive', title: 'Social Testosterone', summary: 'Leading a team, public speaking, winning an argument, receiving admiration — all social victories increase testosterone. Actively pursue social situations that challenge you and allow you to contribute.' },
  ...
  { week: 29, category: 'drive', title: 'The Insula and Interoceptive Awareness', source: 'Biological Psychiatry, 2017', summary: 'The insula processes internal body signals -- heartbeat, gut feelings, arousal. Addiction blunts insular function, disconnecting you from your own body. Recovery restores interoceptive awareness, helping you recognize genuine hunger, fatigue, and desire rather than compulsive urges.' },
  { week: 29, category: 'drive', title: 'Superset Training for Efficiency', summary: 'Pairing opposing muscle groups (chest/back, biceps/triceps) with minimal rest keeps intensity high while allowing adequate recovery. This time-efficient approach maintains the hormonal stimulus of longer sessions.' },
  { week: 29, category: 'drive', title: 'Cortisol Rhythm Normalization at Seven Months', source: 'Psychoneuroendocrinology, 2015', summary: 'Chronic stress and compulsive behavior flatten the natural cortisol curve -- high in the morning, low at night. By month 7, many people in recovery report improved morning energy and easier nighttime sleep, reflecting a restored cortisol rhythm.' },
  { week: 29, category: 'drive', title: 'The Power of Consistency', summary: 'The men who see the greatest hormonal benefits are not those with the most elaborate protocols but those who consistently do the basics: sleep 7-9 hours, lift heavy, eat whole foods, manage stress.' },
  { week: 29, category: 'drive', title: 'Spontaneous Arousal vs Triggered Arousal', source: 'Journal of Sexual Medicine, 2014', summary: 'Healthy sexuality includes spontaneous desire (arising without external triggers) and responsive desire (arising from context and connection). Pornography trains the brain to rely exclusively on triggered arousal. Recovery rebuilds the capacity for spontaneous, context-appropriate desire.' },
  ...
  { week: 30, category: 'drive', title: 'Seven-Month Executive Function Gains', source: 'Neuropsychologia, 2018', summary: 'Executive functions -- planning, decision-making, impulse control -- are governed by the prefrontal cortex, one of the last brain regions to recover from addiction. By month 7, measurable improvements in cognitive flexibility and goal-directed behavior are consistently reported in recovery research.' },
  { week: 30, category: 'drive', title: 'Testosterone and Cognitive Function', source: 'Neuroscience & Biobehavioral Reviews, 2016', summary: 'Optimal testosterone levels are associated with faster processing speed, better spatial reasoning, and improved verbal fluency. Your cognitive enhancement from recovery is partly hormonal.' },
  { week: 30, category: 'drive', title: 'The Minimalist Training Approach', summary: 'Research shows that 3-4 compound exercises, 3 times per week, for 45 minutes produces 80% of maximum hormonal benefit. More is not always better — recovery and consistency matter most.' },
  { week: 30, category: 'drive', title: 'Porn and Objectification: Neuroimaging Evidence', source: 'Valerie Voon, University of Cambridge, 2014', summary: 'Brain imaging studies by Dr. Valerie Voon showed that compulsive pornography users process sexual images differently -- with heightened ventral striatum activation but reduced connectivity to the prefrontal cortex. This neural pattern mirrors substance addiction and decreases with sustained abstinence.' },
  { week: 30, category: 'drive', title: 'The Vagus Nerve and Emotional Resilience', source: 'Frontiers in Psychiatry, 2018', summary: 'The vagus nerve connects the brain to the gut, heart, and lungs, regulating the stress response. Higher vagal tone -- measurable through heart rate variability -- predicts better emotional regulation and resilience. Exercise, deep breathing, and social connection all strengthen vagal tone during recovery.' },
  ...
  { week: 31, category: 'drive', title: 'Testosterone and Emotional Regulation', summary: 'Contrary to stereotypes, optimal testosterone actually improves emotional regulation, not aggression. The "roid rage" effect is from supraphysiological levels; natural optimization produces calm confidence.' },
  { week: 31, category: 'drive', title: 'Calisthenics and Hormonal Benefits', summary: 'Bodyweight exercises — pull-ups, dips, push-ups, pistol squats — can produce hormonal responses comparable to weight training when performed with sufficient intensity and progressive overload.' },
  { week: 31, category: 'drive', title: 'Habit Extinction vs Habit Replacement', source: 'Neuron, 2013', summary: 'Neuroscience distinguishes between habit extinction (weakening an old habit through disuse) and habit replacement (overwriting it with a new behavior). Recovery works best when both strategies combine -- reducing cue exposure while actively building competing healthy routines that use the same neural circuits.' },
  { week: 31, category: 'drive', title: 'Nocturnal Erections and Neurological Recovery', source: 'Journal of Sexual Medicine, 2009', summary: 'Nocturnal penile tumescence (NPT) occurs during REM sleep and is a key marker of neurological and vascular health. Many men in recovery notice increased frequency and firmness of morning erections, indicating that the brain-body arousal pathway is healing.' },
  { week: 31, category: 'drive', title: 'Flow States and Dopamine Sensitivity', source: 'Frontiers in Psychology, 2021', summary: 'Flow -- the state of total absorption in a challenging task -- depends on a well-calibrated dopamine system. As receptor sensitivity normalizes during recovery, the ability to enter flow states increases, providing deep satisfaction without artificial stimulation.' },
  ...
  { week: 32, category: 'drive', title: 'Testosterone and Entrepreneurship', source: 'Management Science, 2018', summary: 'Higher testosterone levels are associated with entrepreneurial tendency, risk tolerance, and competitive drive. Your hormonal optimization may be fueling new ambitions and career aspirations.' },
  { week: 32, category: 'drive', title: 'Rope Training for Full-Body Stimulus', summary: 'Battle ropes, rope climbing, and heavy rope exercises provide a unique metabolic and hormonal stimulus that combines strength, cardio, and core training in a single modality.' },
  { week: 32, category: 'drive', title: 'Eight-Month Brain Imaging Changes', source: 'Simone Kuhn, Max Planck Institute, 2014', summary: 'Dr. Simone Kuhn\'s neuroimaging research demonstrated that heavy pornography use correlates with reduced gray matter in the right caudate and diminished striatal activation. The encouraging finding: these structural changes show recovery potential with sustained abstinence, as the brain\'s plasticity works in both directions.' },
  { week: 32, category: 'drive', title: 'Reward Substitution Strategies That Work', source: 'Addiction Biology, 2019', summary: 'Effective recovery replaces supranormal rewards with naturally rewarding activities that activate overlapping neural circuits. Exercise, creative pursuits, social bonding, and mastery experiences all stimulate dopamine release through healthy pathways, gradually retraining the reward system.' },
  { week: 32, category: 'drive', title: 'Sexual Responsiveness to Real Partners', source: 'Archives of Sexual Behavior, 2016', summary: 'Pornography conditions arousal to specific visual cues, novelty, and escalation. As these conditioned responses weaken during recovery, arousal to real-partner cues -- touch, scent, emotional connection, physical presence -- strengthens. This shift represents a fundamental rewiring of the sexual response system.' },
  ...
  { week: 33, category: 'drive', title: 'The Anterior Insula and Craving Reduction', source: 'Biological Psychiatry, 2018', summary: 'The anterior insula generates conscious awareness of cravings. Neuroimaging shows that insular reactivity to addiction cues decreases significantly with sustained abstinence. By month 8, many people report that cravings feel less urgent and more manageable -- a direct result of insular recalibration.' },
  { week: 33, category: 'drive', title: 'Drop Sets for Metabolic Stress', summary: 'Performing a set to near-failure, immediately reducing weight by 20-30%, and continuing creates intense metabolic stress that triggers growth hormone and testosterone release beyond what straight sets achieve.' },
  { week: 33, category: 'drive', title: 'Working Memory Capacity Gains at Eight Months', source: 'Cognitive, Affective, & Behavioral Neuroscience, 2017', summary: 'Working memory -- the ability to hold and manipulate information in real time -- depends on dorsolateral prefrontal cortex function, which is impaired by addiction. By 8 months, improvements in working memory capacity translate to better focus at work, more engaging conversations, and sharper problem-solving.' },
  { week: 33, category: 'drive', title: 'Healthy Sexual Fantasy vs Compulsive Fantasy', source: 'Sexual Addiction & Compulsivity, 2015', summary: 'Healthy sexual fantasy involves flexibility, emotional content, and partner-oriented scenarios. Compulsive fantasy is rigid, escalating, and disconnected from real relationships. As recovery progresses, fantasy life naturally shifts toward more relational, emotionally integrated content.' },
  { week: 33, category: 'drive', title: 'The Importance of Recovery Weeks', summary: 'Planned deload weeks (every 4-6 weeks of training) allow the endocrine system to fully recover. Short-term reduction in training stress often leads to greater testosterone levels upon resumption.' },
  ...
  { week: 34, category: 'drive', title: 'Synaptic Pruning and Brain Efficiency', source: 'Neuroscience & Biobehavioral Reviews, 2020', summary: 'The brain becomes more efficient not by adding connections but by pruning unused ones. During recovery, synaptic pruning eliminates strengthened porn-related pathways while consolidating healthier neural circuits. This is why cravings weaken over time -- the neural infrastructure supporting them is literally being dismantled.' },
  { week: 34, category: 'drive', title: 'Endocannabinoid System Recovery', source: 'Neuropsychopharmacology, 2018', summary: 'The endocannabinoid system regulates mood, appetite, pain, and pleasure. Chronic overstimulation disrupts endocannabinoid signaling, contributing to anxiety and anhedonia. Recovery allows this system to recalibrate, restoring natural feelings of contentment and reducing background anxiety.' },
  { week: 34, category: 'drive', title: 'Isometric Holds for Strength', summary: 'Holding heavy weights at specific joint angles (isometric training) builds incredible strength and can stimulate hormonal responses. Try 10-20 second holds at the sticking point of your weakest lifts.' },
  { week: 34, category: 'drive', title: 'Testosterone and Sleep Stages', summary: 'Testosterone production is concentrated in specific sleep stages: 60% occurs during deep sleep (stages 3-4) and increases during REM sleep. Sleep quality matters as much as duration.' },
  { week: 34, category: 'drive', title: 'Partner-Focused Arousal Patterns', source: 'Journal of Sex Research, 2017', summary: 'Recovery shifts arousal patterns from screen-based, novelty-driven stimulation to partner-focused responsiveness. This means arousal becomes more attuned to real sensory input -- touch, voice, presence -- creating deeper sexual experiences rooted in genuine connection rather than visual consumption.' },
  ...
  { week: 35, category: 'drive', title: 'Nine-Month Neuroplasticity Assessment', source: 'NeuroImage, 2019', summary: 'At 9 months, the brain has undergone substantial reorganization. Functional connectivity studies show strengthened prefrontal-limbic connections, improved default mode network coherence, and normalized reward circuit sensitivity. These changes underpin the emotional stability and clarity that define long-term recovery.' },
  { week: 35, category: 'drive', title: 'The Benefits of Swimming', summary: 'Swimming provides resistance training through water, cardiovascular benefits, and low-impact joint protection. Cold water swimming adds hormonal benefits from cold exposure.' },
  { week: 35, category: 'drive', title: 'Testosterone and Insulin Sensitivity', source: 'Diabetes Care, 2004', summary: 'Testosterone improves insulin sensitivity, helping the body use glucose more efficiently. This connection explains why hormonal optimization often improves body composition even without dietary changes.' },
  { week: 35, category: 'drive', title: 'The Role of GABA in Anxiety Reduction', source: 'Neuropharmacology, 2017', summary: 'GABA is the brain\'s primary inhibitory neurotransmitter, responsible for calming neural activity. Chronic overstimulation depletes GABAergic tone, contributing to anxiety and restlessness. As GABA signaling normalizes during recovery, many people experience a profound reduction in baseline anxiety.' },
  { week: 35, category: 'drive', title: 'Sexual Confidence Without Performance Scripts', source: 'Journal of Sex & Marital Therapy, 2018', summary: 'Pornography teaches rigid performance scripts that create performance anxiety during real encounters. Recovery builds authentic sexual confidence rooted in presence, attunement, and genuine desire rather than rehearsed sequences -- leading to more satisfying experiences for both partners.' },
  ...
  { week: 36, category: 'drive', title: 'Default Mode Network and Self-Reflection', source: 'Proceedings of the National Academy of Sciences, 2019', summary: 'The default mode network (DMN) is active during self-reflection, future planning, and social cognition. Addiction disrupts DMN function, impairing self-awareness. Recovery restores healthy DMN activity, enabling deeper self-reflection, more accurate self-assessment, and better understanding of your own motivations and values.' },
  { week: 36, category: 'drive', title: 'Testosterone and Leadership', summary: 'Optimal testosterone is associated with assertive but not aggressive leadership. The calm confidence of hormonal balance makes you naturally more effective in leadership roles at work and in relationships.' },
  { week: 36, category: 'drive', title: 'Heavy Bag Training', summary: 'Heavy bag work combines explosive power, cardiovascular conditioning, and stress relief. The primal satisfaction of striking produces a unique hormonal cocktail of testosterone, adrenaline, and endorphins.' },
  { week: 36, category: 'drive', title: 'Opioid System Recovery and Natural Pleasure', source: 'Molecular Psychiatry, 2018', summary: 'The brain\'s endogenous opioid system mediates the pleasure of social bonding, physical touch, and achievement. Chronic supranormal stimulation downregulates opioid receptors. Recovery restores opioid sensitivity, which is why simple pleasures -- a warm conversation, a sunset, physical affection -- begin feeling deeply satisfying again.' },
  { week: 36, category: 'drive', title: 'Intimacy Readiness Indicators', source: 'Journal of Social and Personal Relationships, 2020', summary: 'Neuroscience research identifies key markers of readiness for healthy intimacy: stable emotional regulation, capacity for empathy without emotional flooding, ability to tolerate vulnerability, and sexual responsiveness to real-partner cues. By 9 months of recovery, most of these capacities are substantially restored.' },
  ...
  { week: 37, category: 'drive', title: 'Testosterone and Memory', summary: 'Optimal testosterone levels support hippocampal function, improving memory consolidation and recall. The "mental clarity" often reported during recovery is partially explained by this hormonal-cognitive connection.' },
  { week: 37, category: 'drive', title: 'Kettlebell Training', summary: 'Kettlebell swings, cleans, and snatches combine strength and cardio in a unique way that produces strong hormonal responses. A 20-minute kettlebell session can match the hormonal output of a 45-minute gym session.' },
  { week: 37, category: 'drive', title: 'Long-Term Potentiation and New Neural Pathways', source: 'Nature Reviews Neuroscience, 2020', summary: 'Long-term potentiation (LTP) is the mechanism by which repeated neural activation strengthens synaptic connections. Every healthy habit you practice -- exercise, social connection, creative work -- is physically strengthening new neural pathways through LTP, making healthy behaviors increasingly automatic.' },
  { week: 37, category: 'drive', title: 'Social Reward Sensitivity Improvements', source: 'Social Cognitive and Affective Neuroscience, 2019', summary: 'The brain\'s social reward circuits overlap substantially with its general reward system. As dopamine sensitivity recovers, social interactions become more rewarding -- conversations feel more engaging, friendships more fulfilling, and collaborative work more satisfying. This enhanced social reward sensitivity is a powerful protective factor against relapse.' },
  { week: 37, category: 'drive', title: 'Ejaculatory Control and Neurological Maturation', source: 'Journal of Sexual Medicine, 2016', summary: 'Ejaculatory control involves complex coordination between the sympathetic nervous system, pelvic floor muscles, and prefrontal inhibitory circuits. Pornography-induced overstimulation can dysregulate this system. Recovery restores balanced neurological control, and many men report improved stamina and better ability to modulate arousal during partnered sex.' },
  ...
  { week: 38, category: 'drive', title: 'Testosterone and Longevity', source: 'Journal of Clinical Endocrinology & Metabolism, 2008', summary: 'Men with optimal (not excessive) testosterone levels show reduced all-cause mortality. The lifestyle habits that support testosterone — exercise, sleep, nutrition, stress management — also support longevity.' },
  { week: 38, category: 'drive', title: 'Trail Running Benefits', summary: 'Trail running combines the hormonal benefits of running with the cognitive demands of navigating uneven terrain and the stress-reducing effects of nature exposure. It is a triple-benefit activity.' },
  { week: 38, category: 'drive', title: 'Ten-Month Comprehensive Brain Assessment', source: 'Biological Psychiatry: Cognitive Neuroscience and Neuroimaging, 2020', summary: 'At 10 months, neuroimaging studies show substantial recovery across multiple brain systems: normalized striatal reactivity, strengthened prefrontal cortex thickness, improved white matter integrity, and restored functional connectivity between emotion and cognition centers. Your brain is fundamentally different from where it started.' },
  { week: 38, category: 'drive', title: 'Stress Inoculation from Sustained Recovery', source: 'Psychological Bulletin, 2019', summary: 'Successfully navigating 10 months of recovery builds stress inoculation -- the proven psychological phenomenon where overcoming challenges increases resilience to future stressors. Each craving resisted, each difficult emotion processed, and each healthy choice made has strengthened your capacity to handle whatever life brings.' },
  { week: 38, category: 'drive', title: 'Authentic Sexual Expression', source: 'Archives of Sexual Behavior, 2019', summary: 'Authentic sexual expression means your sexual desires, fantasies, and behaviors align with your genuine preferences rather than conditioned responses from pornography. Recovery creates space to discover what truly arouses you in the context of real connection, leading to more fulfilling and personally meaningful sexual experiences.' },
  ...
  { week: 39, category: 'drive', title: 'Testosterone and Assertiveness', summary: 'Optimal testosterone promotes healthy assertiveness — the ability to express your needs and boundaries clearly without aggression. This is one of the most valued social skills in both personal and professional life.' },
  { week: 39, category: 'drive', title: 'Rock Climbing for Full-Body Challenge', summary: 'Rock climbing engages every muscle group, requires problem-solving, builds mental toughness, and produces a robust hormonal response. Indoor climbing is accessible year-round.' },
  { week: 39, category: 'drive', title: 'Approach Motivation vs Avoidance Motivation', source: 'Psychological Review, 2018', summary: 'Early recovery is driven by avoidance motivation -- moving away from pain. Sustained recovery shifts to approach motivation -- moving toward valued goals. This shift, mediated by prefrontal cortex recovery and dopamine rebalancing, marks a fundamental transformation from surviving to thriving.' },
  { week: 39, category: 'drive', title: 'The Neuroscience of Self-Compassion', source: 'Kristin Neff, NeuroImage, 2020', summary: 'Self-compassion activates the caregiving system (ventromedial prefrontal cortex and insula) rather than the threat system (amygdala). Brain imaging shows self-compassion practices reduce cortisol, increase heart rate variability, and strengthen the same neural circuits that support sustained recovery.' },
  { week: 39, category: 'drive', title: 'Sexual Health as Holistic Wellness Indicator', source: 'World Health Organization; Journal of Sexual Medicine, 2019', summary: 'Sexual health is not merely the absence of dysfunction -- it is a positive indicator of overall neurological, psychological, and relational wellness. Healthy arousal, genuine desire, satisfying intimacy, and comfortable sexual identity all reflect a brain and body in balance. Your sexual health is a barometer of your total recovery.' },
  ...
  { week: 40, category: 'drive', title: 'Ten-Month Dopamine System Maturation', summary: 'By 10 months, your dopamine system has undergone remarkable maturation. D2 receptor density has normalized, baseline dopamine tone is stable, and your reward circuitry now responds proportionally to natural rewards. This is the neurological foundation of sustained motivation.' },
  { week: 40, category: 'drive', title: 'Boxing and Combat Sports', summary: 'Combat sports combine intense physical training with competitive drive, producing powerful testosterone responses. Even bag work and pad drills without sparring provide significant hormonal benefits.' },
  { week: 40, category: 'drive', title: 'Relapse Neuroscience: Why Single Slips Don\'t Reset Everything', summary: 'Neuroscience shows that a single lapse does not erase months of neural rewiring. The strengthened prefrontal pathways, restored receptor density, and new behavioral patterns you\'ve built are durable. A slip is a data point, not a demolition — your brain\'s architecture of recovery remains largely intact.' },
  { week: 40, category: 'drive', title: 'Authentic Drive vs Compensatory Behavior', summary: 'There is a critical difference between drive that emerges from genuine purpose and drive that compensates for emptiness. Authentic motivation feels energizing yet calm — it pulls you forward rather than pushing you away from pain. At 10 months, you can increasingly distinguish the two.' },
  { week: 40, category: 'drive', title: 'Ten-Month Hormonal Wisdom', summary: 'At 10 months, you possess hormonal wisdom — you know what works for your body, what doesn\'t, and how to maintain balance. Trust your experience. You are your own best expert now.' },
  ...
  { week: 41, category: 'drive', title: 'Testosterone and Decision Quality', summary: 'Optimal testosterone improves decision-making speed and quality by enhancing prefrontal cortex function. You may notice that decisions feel clearer and more confident than they did months ago.' },
  { week: 41, category: 'drive', title: 'Dancing and Hormonal Benefits', summary: 'Social dancing combines physical movement, music, social connection, and touch — all testosterone-supportive activities. It\'s also one of the most enjoyable ways to stay physically active.' },
  { week: 41, category: 'drive', title: 'Cognitive Flexibility Improvements at 10 Months', summary: 'Research on cognitive recovery shows that cognitive flexibility — the ability to shift between concepts and adapt thinking — continues improving well past initial recovery. At 10 months, your prefrontal cortex supports more creative problem-solving, better perspective-taking, and faster mental pivots than at any earlier stage.' },
  { week: 41, category: 'drive', title: 'The Neuroscience of Purpose-Driven Motivation', summary: 'Purpose activates the ventromedial prefrontal cortex and anterior insula — brain regions that connect abstract goals to felt meaning. People with strong purpose show higher dopamine efficiency, meaning they extract more motivation from less neurochemical stimulation. Purpose is a biological advantage.' },
  { week: 41, category: 'drive', title: 'Sexual Wellness as Relationship Foundation', summary: 'Healthy sexuality after recovery is built on presence, attunement, and genuine desire rather than compulsion. Research shows that couples who communicate openly about sexual needs report higher relationship satisfaction and more stable attachment bonds. Your recovery has given you the capacity for this kind of authentic sexual connection.' },
  ...
  { week: 42, category: 'drive', title: 'Autobiographical Memory Improvements', summary: 'At 10.5 months, your hippocampus and medial prefrontal cortex have strengthened their connection, improving autobiographical memory — the ability to construct a coherent narrative of your life. This enhanced self-narrative supports identity integration and helps you see your recovery as part of a meaningful life story.' },
  { week: 42, category: 'drive', title: 'The Benefits of Rowing', summary: 'Rowing engages 86% of muscles in the body, provides exceptional cardiovascular conditioning, and produces a robust hormonal response. Whether machine, boat, or erg, rowing is a complete exercise.' },
  { week: 42, category: 'drive', title: 'Reward System Calibration at 10.5 Months', summary: 'Your reward system has undergone a profound recalibration. The nucleus accumbens now responds robustly to natural pleasures — a good meal, meaningful conversation, physical achievement — that once barely registered. This is not returning to baseline; this is arriving at a sensitivity many people never develop.' },
  { week: 42, category: 'drive', title: 'Testosterone at Different Life Stages', summary: 'Your testosterone needs and levels change throughout life. The habits you\'ve built during recovery will serve you at every stage — from the ambition of your 20s to the wisdom of your later years.' },
  { week: 42, category: 'drive', title: 'Healthy Masculinity and Neurological Wholeness', summary: 'Neuroscience reveals that healthy masculinity integrates strength with empathy, ambition with compassion, and assertiveness with attunement. The prefrontal-limbic integration you have built supports all of these simultaneously — proving that wholeness, not suppression, is the foundation of authentic masculine drive.' },
  ...
  { week: 43, category: 'drive', title: 'Sustained Attention Improvements', summary: 'Your sustained attention capacity — the ability to maintain focus on a single task for extended periods — has dramatically improved. Research shows that this executive function continues strengthening even at 10+ months of recovery, as prefrontal cortex myelination completes its restoration.' },
  { week: 43, category: 'drive', title: 'Functional Fitness Movements', summary: 'As you approach a year of hormonal optimization, consider shifting focus toward functional movements — carrying, pulling, pushing, climbing — that build real-world strength and maintain hormonal benefits.' },
  { week: 43, category: 'drive', title: 'The Neuroscience of Emotional Intimacy', summary: 'Emotional intimacy activates oxytocin and vasopressin systems that create lasting pair bonds. After months of recovery, your capacity for this neurochemistry has been fully restored. The anterior insula and anterior cingulate cortex — regions essential for feeling another person\'s emotional state — are functioning at their peak.' },
  { week: 43, category: 'drive', title: 'Testosterone and Stress Resilience', summary: 'Optimal testosterone doesn\'t just reduce stress — it improves your capacity to handle stress effectively. Stressful situations that once felt overwhelming now feel manageable.' },
  { week: 43, category: 'drive', title: 'Brain-Derived Neurotrophic Factor and Lifestyle', summary: 'BDNF — brain-derived neurotrophic factor — is the protein that supports new neural growth and strengthens existing connections. Exercise, sleep, social connection, and learning all boost BDNF production. Your recovery lifestyle is a BDNF-optimizing protocol, continuously supporting the brain\'s capacity for growth and adaptation.' },
  ...
  { week: 44, category: 'drive', title: 'Eleven-Month Executive Function Assessment', summary: 'At 11 months, your executive functions — planning, decision-making, impulse control, working memory — have undergone comprehensive restoration. Neuroimaging studies show that prefrontal cortex activation patterns in people at this stage are indistinguishable from those who never experienced addiction.' },
  { week: 44, category: 'drive', title: 'Mobility Work and Hormonal Recovery', summary: 'Dedicated mobility work (stretching, yoga, foam rolling) reduces chronic muscle tension that elevates cortisol. Flexible muscles and joints support better training form and greater hormonal response.' },
  { week: 44, category: 'drive', title: 'Testosterone and Confidence Calibration', summary: 'Optimal testosterone produces well-calibrated confidence — not arrogance or insecurity, but an accurate sense of your abilities. This calibration is one of the most valuable traits in personal and professional life.' },
  { week: 44, category: 'drive', title: 'Impulse Surfing Mastery', summary: 'By 11 months, you have mastered the art of impulse surfing — observing urges without acting on them. This skill has rewired your anterior cingulate cortex, the brain region responsible for conflict monitoring. Urges still arise occasionally, but they pass through you like weather rather than controlling your behavior.' },
  { week: 44, category: 'drive', title: 'Sexual Self-Knowledge and Authenticity', summary: 'True sexual self-knowledge means understanding your authentic desires separate from conditioned responses. At 11 months, you can distinguish between genuine attraction and compulsive patterns. This self-awareness is the foundation of a fulfilling sexual life built on choice rather than compulsion.' },
  ...
  { week: 45, category: 'drive', title: 'Neural Efficiency at 11 Months', summary: 'Your brain is now operating with remarkable efficiency. Neural pruning has eliminated unnecessary connections while myelination has strengthened essential pathways. The result is faster processing, clearer thinking, and less mental energy wasted on internal conflict. This efficiency is the neurological signature of a recovered brain.' },
  { week: 45, category: 'drive', title: 'CrossFit-Style Training', summary: 'High-intensity, varied functional movements (CrossFit methodology) produce excellent hormonal responses through combinations of strength, cardiovascular, and gymnastic elements. Variety prevents adaptation.' },
  { week: 45, category: 'drive', title: 'The Neuroscience of Gratitude and Drive', summary: 'Gratitude practice activates the ventral tegmental area and nucleus accumbens — the same reward circuits involved in motivation. Research from UCLA shows that regular gratitude practice increases dopamine production by up to 10%, creating a virtuous cycle where appreciation fuels drive and achievement generates more gratitude.' },
  { week: 45, category: 'drive', title: 'Testosterone and Seasonal Activities', summary: 'Vary your physical activities seasonally: swimming in summer, hiking in fall, skiing in winter, running in spring. Seasonal variation provides novel stimuli and keeps training enjoyable year-round.' },
  { week: 45, category: 'drive', title: 'Relationship Neuroscience: Secure Attachment', summary: 'Secure attachment — the ability to trust, be vulnerable, and maintain closeness without anxiety or avoidance — is supported by balanced oxytocin and cortisol systems. Your recovery has restored these systems to optimal function. Securely attached partners show better conflict resolution, deeper intimacy, and more resilient relationships.' },
  ...
  { week: 46, category: 'drive', title: 'Prefrontal-Limbic Balance Mastery', summary: 'The hallmark of a fully recovered brain is balanced communication between the prefrontal cortex (rational planning) and the limbic system (emotional impulse). At nearly one year, this balance has become your default state — emotions inform your decisions without hijacking them. This is neurological maturity.' },
  { week: 46, category: 'drive', title: 'Outdoor Training Benefits', summary: 'Training outdoors — park workouts, outdoor gyms, trail running — combines exercise hormonal benefits with nature exposure and vitamin D production. The combined effect exceeds indoor training alone.' },
  { week: 46, category: 'drive', title: 'Intrinsic vs Extrinsic Motivation at 11.5 Months', summary: 'Research by Deci and Ryan shows that intrinsic motivation — doing things because they are inherently meaningful — produces more sustainable drive than external rewards. At 11.5 months, your motivation has shifted from extrinsic (avoiding consequences) to intrinsic (pursuing what matters). This shift is both psychological and neurological.' },
  { week: 46, category: 'drive', title: 'Maintaining vs. Gaining', summary: 'The effort required to maintain hormonal optimization is less than the effort to gain it. You\'ve done the hard work. Now coast at altitude with consistent, sustainable habits.' },
  { week: 46, category: 'drive', title: 'Complete Sexual Health Assessment', summary: 'At nearly one year, take stock of your sexual wellness: Are you experiencing genuine desire? Can you be fully present during intimacy? Do you feel connected to your partner? Sexual health in recovery is not just about function — it is about presence, connection, and authentic expression of desire.' },
  ...
  { week: 47, category: 'drive', title: 'Approaching One Year: Comprehensive Brain Recovery', summary: 'As you approach one year, your brain has undergone comprehensive recovery across every measurable domain. Prefrontal cortex thickness, white matter integrity, dopamine receptor density, and default mode network connectivity all show restoration. You are not the same brain that started this journey.' },
  { week: 47, category: 'drive', title: 'The Neuroscience of Mentoring Others', summary: 'When you mentor someone in recovery, mirror neurons activate in both brains, creating synchronized neural patterns. Teaching others strengthens your own recovery pathways while building new connections in the mentee\'s brain. Mentoring is not just altruism — it is a neurological reinforcement of everything you have learned.' },
  { week: 47, category: 'drive', title: 'Testosterone and Leadership Capacity', summary: 'Nearly a year of hormonal optimization has likely expanded your leadership capacity — in relationships, at work, in your community. Testosterone supports the confident, decisive, caring leader within you.' },
  { week: 47, category: 'drive', title: 'The Compound Effect of Consistency', summary: 'Eleven months of consistent hormonal optimization practices have compounded. Like interest on investment, the returns accelerate over time. Your current state is the compound interest of daily good choices.' },
  { week: 47, category: 'drive', title: 'Drive Channeled into Life Purpose', summary: 'The raw energy that once fed compulsive behavior is now available for life purpose. This is not metaphorical — the same dopaminergic circuits that powered addiction now power your ambitions, creativity, and contribution. The energy was never the problem; it just needed worthy channels.' },
  ...
  { week: 48, category: 'drive', title: 'Year-One Neural Pathway Consolidation', summary: 'At one year, the neural pathways of recovery have consolidated through long-term potentiation — the same mechanism that creates all lasting memories and skills. These pathways are not fragile new growth; they are established neural architecture that will serve you for life.' },
  { week: 48, category: 'drive', title: 'Planning Year Two Training', summary: 'With a year of training behind you, consider new challenges: a competition, a new sport, a physical feat. New goals keep training exciting and maintain the hormonal benefits of progressive overload.' },
  { week: 48, category: 'drive', title: 'Relapse Prevention: The Neuroscience Approach', summary: 'Understanding relapse neuroscience is protective: stress reactivates old cue-response associations in the amygdala and dorsal striatum, but your strengthened prefrontal cortex can override these signals. Knowing the mechanism — and having practiced the override thousands of times — makes you resilient, not fragile.' },
  { week: 48, category: 'drive', title: 'The Simple Daily Non-Negotiables', summary: 'After a year, distill your practice to the non-negotiables: 7-9 hours sleep, 30+ minutes of movement, whole food nutrition, one stress-management practice. Everything else is optional optimization.' },
  { week: 48, category: 'drive', title: 'Integrated Sexual Wellness', summary: 'Integrated sexual wellness means your sexuality is aligned with your values, connected to your emotions, and expressed in ways that deepen relationships. At one year, you have built the neural infrastructure for this integration — the prefrontal cortex guides expression while the limbic system provides genuine desire and warmth.' },
  ...
  { week: 49, category: 'drive', title: 'Brain Recovery Complete: What the Research Shows', summary: 'Comprehensive research reviews confirm that 12 months of sustained behavioral change produces complete neurological recovery in the vast majority of cases. Gray matter volume, white matter integrity, neurotransmitter function, and neural connectivity have all returned to healthy baselines — and in some measures, exceed them.' },
  { week: 49, category: 'drive', title: 'The Next Challenge', summary: 'With hormonal health established, consider new physical challenges: a marathon, a triathlon, a strength competition, a mountain climb. Your optimized body is ready for ambitious goals.' },
  { week: 49, category: 'drive', title: 'The Neuroscience of New Beginnings', summary: 'Your brain is wired for new beginnings. The hippocampus generates new neurons throughout life, and the prefrontal cortex can form new goals at any age. Day 365 is not an ending — it is the neurological launchpad for whatever you build next. Your brain is ready for the next chapter.' },
  { week: 49, category: 'drive', title: 'Maintaining Dopamine Sensitivity Long-Term', summary: 'The dopamine sensitivity you have restored is a precious asset. Maintain it through continued engagement with natural rewards, regular exercise, quality sleep, and meaningful social connection. Avoid the trap of substituting one superstimulus for another. Your calibrated reward system is your greatest neurological achievement.' },
  { week: 49, category: 'drive', title: 'Gratitude for Your Body', summary: 'Your body carried you through this transformation. It adapted, recovered, and optimized. Take a moment to appreciate the remarkable biological machine that you are. Treat it with the respect it deserves.' },
  ...
  { week: 50, category: 'drive', title: 'One Year of Neuroplastic Change', summary: 'Neuroplasticity — the brain\'s ability to reorganize itself — has been your greatest ally this year. Every healthy choice strengthened recovery pathways. Every resisted urge weakened compulsive ones. The cumulative result is a brain that has literally rebuilt itself around your values and intentions.' },
  { week: 50, category: 'drive', title: 'Reward System Wisdom', summary: 'You now possess something rare: wisdom about your own reward system. You understand what triggers cravings, what satisfies deeply versus superficially, and how to cultivate lasting fulfillment. This self-knowledge — earned through a year of mindful living — is more valuable than any external achievement.' },
  { week: 50, category: 'drive', title: 'Evolving Your Practice', summary: 'A year of experience has taught you what works best for your unique body. Continue evolving your practices based on how you feel, not just what the research says. You are the expert now.' },
  { week: 50, category: 'drive', title: 'Drive as Life Force', summary: 'Drive is not just ambition or productivity — it is life force itself. The energy flowing through you now is the same energy that fuels creativity, love, adventure, and purpose. At one year, this drive is no longer reactive or desperate. It is calm, directed, and deeply rooted in who you have become.' },
  { week: 50, category: 'drive', title: 'Celebrating Your Body', summary: 'Your body has been your partner in this transformation. Celebrate it — its strength, its resilience, its capacity for healing. You and your body did this together.' },
  ...
  { week: 51, category: 'drive', title: 'Sustained Recovery Neuroscience', summary: 'The neuroscience of sustained recovery shows that after one year, the brain has shifted from active recovery mode to a stable maintenance state. The vigilance required in early months gives way to a more effortless self-regulation. Your healthy patterns have become the path of least resistance — the default mode of a transformed brain.' },
  { week: 51, category: 'drive', title: 'Setting New Physical Goals', summary: 'With a year of hormonal optimization, you are ready for ambitious physical goals. A competition, a personal best, an adventure race. Your body is primed. Challenge it.' },
  { week: 51, category: 'drive', title: 'Teaching Others: Mirror Neuron Activation', summary: 'When you share your recovery experience with others, mirror neurons in the listener\'s brain simulate your journey. Research shows that authentic storytelling activates the same neural regions in the listener as the teller experienced. Your story is literally transformative — it can spark neural change in someone who hears it.' },
  { week: 51, category: 'drive', title: 'Testosterone and Purpose-Driven Living', summary: 'Your optimized testosterone now fuels purpose-driven living. The energy, drive, and confidence you\'ve built serve something bigger than yourself. Use them well.' },
  { week: 51, category: 'drive', title: 'Sexual Wholeness and Freedom', summary: 'Sexual wholeness means your sexuality is integrated with your whole self — your emotions, your values, your relationships, your identity. At one year, you have the capacity for sexual experiences that are simultaneously passionate and present, exciting and emotionally safe. This is what sexual freedom actually looks like.' },
  ...
  { week: 52, category: 'drive', title: 'Year-One Complete: The Transformed Brain', summary: 'Three hundred sixty-five days of neuroplastic transformation. Your brain has rebuilt itself — new pathways strengthened, old compulsions weakened, prefrontal cortex restored, reward system recalibrated. This is not the brain you started with. This is the brain you built, one courageous day at a time.' },
  { week: 52, category: 'drive', title: 'Dopamine Wisdom for Life', summary: 'You now carry dopamine wisdom that most people never acquire: the understanding that lasting fulfillment comes from earned rewards, meaningful effort, and genuine connection — not from superstimuli that hijack the reward system. This wisdom will protect and guide you for the rest of your life.' },
  { week: 52, category: 'drive', title: 'The Complete Man', summary: 'Optimal hormonal health is one component of the complete man: physical vitality combined with emotional depth, intellectual curiosity, and spiritual purpose. You are becoming complete.' },
  { week: 52, category: 'drive', title: 'The Neuroscience of Freedom', summary: 'Freedom is not just a feeling — it is a measurable neurological state. Your prefrontal cortex can now override limbic impulses, your default mode network supports a stable sense of self, and your reward system responds to reality rather than fantasy. This is what neuroscience calls executive autonomy. This is freedom.' },
  { week: 52, category: 'drive', title: 'Celebration', summary: 'Celebrate your body. Celebrate your discipline. Celebrate the vitality that pulses through you. You earned this — every ounce of energy, every degree of confidence, every moment of clarity.' },
