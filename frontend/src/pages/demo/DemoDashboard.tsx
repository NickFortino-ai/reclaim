  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="text-center text-sm text-gray-500">
        <p>Explore the demo: <Link to="/demo/resources" className="text-primary-600 hover:underline">Resources</Link> • <Link to="/demo/community" className="text-primary-600 hover:underline">Community</Link></p>
      </div>
    </div>
  );
}
